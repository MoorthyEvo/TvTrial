...
public class WebServiceClient extends AsyncTask<String, Void, String> {
    ...
    public WebServiceListener listener = null;
    ...
    public WebServiceClient(String url1, JSONObject params) {
        this.url = url1;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            JSONObject postDataParams = postParams;
    ...
    protected void onPostExecute(String response) {
        ...
        listener.onLoginActionComplete(response);
    }
